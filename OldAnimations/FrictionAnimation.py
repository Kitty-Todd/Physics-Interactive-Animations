...
class Friction(Scene):
    def construct(self):
            ...
            a3 = Arrow(start = d.get_left(), end = LEFT*(sf/7-3.5) + UP*1.5, color = RED, stroke_width = 4) #dot static friction!!
            a3a = Arrow(start = d.get_left(), end = LEFT*(kf/7-3.5) + UP*1.5, color = RED, stroke_width = 4) #dot kinetic friction!!
