...
class Friction(Scene):
    def construct(self):
        ...
        a = Arrow(start = b.get_right(), end = RIGHT*(fs+3.1) + DOWN * 1.45, color = BLUE, stroke_width = 4) #block applied force start!!
        aa = Arrow(start = b.get_right(), end = RIGHT*(fk+3.1) + DOWN * 1.45, color = BLUE, stroke_width = 4) #block applied force end!!
        a1 = Arrow(start = d.get_right(), end = LEFT*(3.5-fs/7) + UP*1.5, color = BLUE, stroke_width = 4) #dot applied force start!!
        a1a = Arrow(start = d.get_right(), end = LEFT*(3.5-fk/7) + UP*1.5, color = BLUE, stroke_width = 4) #dot applied force end!!
